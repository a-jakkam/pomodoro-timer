...
HD_PWD='E:/Elky/UIUC/Courses/Spring2026/hardware-hackathon/pomodoro_timer_project/pomodoro_timer_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pomodoro_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pomodoro_top.tcl
