...
HD_PWD='E:/Elky/UIUC/Courses/Spring2026/hardware-hackathon/pomodoro_timer_project/pomodoro_timer_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pomodoro_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pomodoro_top.tcl -notrace
